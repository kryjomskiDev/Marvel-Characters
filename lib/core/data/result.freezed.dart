...
class _$ResultTearOff {
  ...
  ResultError<T> error<T>(String? message) {
...
/// @nodoc
abstract class $ResultErrorCopyWith<T, $Res> {
  factory $ResultErrorCopyWith(
          ResultError<T> value, $Res Function(ResultError<T>) then) =
      _$ResultErrorCopyWithImpl<T, $Res>;
  $Res call({String? message});
}

/// @nodoc
class _$ResultErrorCopyWithImpl<T, $Res> extends _$ResultCopyWithImpl<T, $Res>
    implements $ResultErrorCopyWith<T, $Res> {
  _$ResultErrorCopyWithImpl(
      ResultError<T> _value, $Res Function(ResultError<T>) _then)
      : super(_value, (v) => _then(v as ResultError<T>));

  @override
  ResultError<T> get _value => super._value as ResultError<T>;
...
class _$ResultError<T> implements ResultError<T> {
  const _$ResultError(this.message);
...
abstract class ResultError<T> implements Result<T> {
  const factory ResultError(String? message) = _$ResultError<T>;
